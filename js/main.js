    ...
    var stickyTop = $('#sidescroll').offset().top;
	    $(window).scroll(function(){
	      ...
	      if (stickyTop < windowTop){
		      $('#sidescroll').css({ position: 'fixed', top: -47 });
	      } else {
...
( function() {
	...
	// alert("We are having technical difficulties with our phone number" + "\n" +
	// 	"Please contact us in the meantime directly at the following:" + "\n" +
	// 	"215-671-4300 or" + "\n" +
	// 	"215-357-4580" + "\n" +
	// 	"Our main number should be back up shortly. We thank you for your patience");
} )();